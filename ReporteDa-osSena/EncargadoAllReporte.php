	...
	<header>
		...
		<nav class="navEncargado">
			<ul>
				...
				<li><a href="EncargadoAllReporte.php"><img src="imagenes/BotonAllreportesE.jpg"></a></li>
				<li><a href="ControlEncargado.php"><img src="imagenes/BotonAtender.jpg"></a></li>
		  ...
		  <article>
			    <div>
			    	...
			    	<form action="" method="POST">
                     ...
                     $Cedula=$_SESSION['Cedula'];
                     echo "<b style='color:orange; font-size:15px; text-shadow:3px 3px 10px aqua;'>Reportes hechos por los usuarios</b>";
			    	 ...
			    	 $Cedula=$_SESSION['Cedula'];
                        if (isset($_POST['Btn1'])) {
                        	...
                        	if ($btn==" Listar "){
                             	 ...
                             	 $sql="SELECT * FROM `reportes` WHERE Obreros='$Cedula' ORDER BY idReporte DESC";
